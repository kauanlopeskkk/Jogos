...
@app.post("/adicionar_Jogos/{id_jogo}")
def adicionar_Jogo(id_jogo: int, jogo: Jogo, db: Session = Depends(sessao_db), _: HTTPBasicCredentials = Depends(autenticar_usuario)):
